...
class Game {
    constructor() {
        ...
        this.gameEndInstructions = document.getElementById('gameEndInstructions');
        ...
        if (this.isMobile) {
            this.instructions.innerHTML = 'Tap to place the block';
        }
    ...
    getBestScore() {
        return localStorage.getItem('tower-blocks-bestScore') || 0;
    }

    setBestScore(score) {
        localStorage.setItem('tower-blocks-bestScore', score);
    }
    ...
    restartGame() {
        ...
        this.scoreContainer.classList.remove('hide');
        this.gameEndInstructions.classList.add('hide');
    ...
    addBlock() {
        ...
        this.stage.setCamera(this.blocks.length * 1.9);
    ...
    endGame() {
        ...
        this.gameEndInstructions.classList.remove('hide');
        this.gameEndInstructions.classList.add('popup');
        ...
        scoreText.innerHTML = `Your Score: ${currentScore}`;
        bestScoreText.innerHTML = `Best Score: ${this.getBestScore()}`;
